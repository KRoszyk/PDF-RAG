...
class LeftColumnState(BaseModel):
    buttons_panel_layout: list[float] = [0.5, 1, 0.1, 1, 0.5]  # These values are hardcoded to set widths of the streamlit buttons.
    ...
    rag_created: bool = False


class RightColumnState(BaseModel):
    buttons_panel_layout: list[float] = [0.5, 0.5, 1, 0.1, 1, 0.5]  # These values are hardcoded to set widths of the streamlit buttons.
